...
// Packed features (8x 8-bit) for efficient 64-bit AXI transfers
typedef ap_uint<64> packed_feat_t;

// Top-level IP
void svm_classifier(const packed_feat_t *x_images, // [NIMG * DIM / 8]
                    pred_t *y_pred                 // [NIMG]
);
